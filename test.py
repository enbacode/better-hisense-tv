...
class HisenseTVController:
    ...
    async def turn_on(self):
        ...
        if tv_state:
            ...
            logger.error("Failed to get TV state.")
            raise RuntimeError("Failed to get TV state.")
...
async def main():
    ...
    await tv.request_auth_code()
    auth_code = input("Enter the four digits displayed on your TV: ").strip
    await tv.turn_on()
